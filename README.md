...
<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=28&pause=1000&color=F24E76&center=true&vCenter=true&width=600&lines=Selamlar,+Ben+Ali+KARPAT!;Full+Stack+Developer;Game+Dev+Enthusiast;Leveling+Up+My+Skills..." alt="Typing SVG" />
...
<table align="center" border="0" width="100%">
  <tr>
    <td width="55%" valign="top">
      <h3>👨‍💻 Karakter Özellikleri (About Me)</h3>
      <br>
      <ul>
        <li>🔭 <b>Mevcut Görev:</b> Farklı projeler üzerinde çalışıyor.</li>
        <li>🌱 <b>Skill Yükleniyor:</b> JavaScript & Game Dev.</li>
        <li>👯 <b>Aranan Party Üyesi:</b> Oyun kodlama projeleri.</li>
        <li>💬 <b>Bilgi:</b> Yazılım & Teknoloji konuşabiliriz.</li>
        <li>⚡ <b>Fun Fact:</b> Kod yazmadığımda muhtemelen oyun oynuyorum.</li>
      </ul>
    </td>
    <td width="45%" valign="top" align="center">
      <h3>🛠️ Envanter (Tech Stack)</h3>
      <br>
      <a href="https://skillicons.dev">
        <img src="https://skillicons.dev/icons?i=py,js,html,css,react,git,github,vscode,figma&perline=3&theme=dark" />
      </a>
    </td>
  </tr>
</table>
